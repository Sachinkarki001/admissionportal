        ...
        <div className="sticky w-[100%] bg-rose-700 z-10 rounded-xl">
          <div className="con grid grid-cols-10 -mb-36 sm-no-x-padding gap-2">
            <div className="lg:-mt-8 text-center col-span-2">
              <img
                className="max-h-48 mb-1 md:-mb-8 rounded-r-3xl md:shadow-xl p-4 md:bg-teal-600 "
                src="#"
              />{" "}
            </div>
      ...
      <div className="mt-24 hidden md:block shadow-xl">
        <div className="sticky org-left">
          <ul className="flex flex-row py-4 rounded-r-xl text-m font-medium bg-rose-700 text-white items-center justify-evenly">
            ...
            <li>
              <a href="#salient_features" className="hover-item detect">
                Salient Features
              </a>
            </li>
            <li>
      ...
      <div className="con org-detail md:grid bg-teal-700 items-center text-center">
          ...
          <div className="text-white">
            ...
            <div className="text-center mt-4" id="programs">
              ...
              <div className="grid grid-cols-1 gap-4 px-16">
                <div className="bg-rose-700 rounded-xl py-5 pb-2 mb-2 w-[100%] border-b last:border-b-0 text-center items-center content-center">
                  <div className="flex justify-center">
                    <a
                      href="/college/st-xaviers-college/program/bachelor-of-information-management-bim-tribhuvan-university/"
                      className="font-bold"
                    >
                      Bachelor of Information Management
                      <span className="italic text-sm">(BIM)</span>
                    </a>
                  </div>
                  <div className="text-md mb-1">
                    <a href="/university/tribhuvan-university/" className="">
            ...
            <div id="salient_features" className="mt-6 text-center">
              <h2 className="text-xl text-white mb-4 uppercase">
                Salient Features
              </h2>
              <div className="prose max-w-none text-white"></div>
            </div>
            <hr className="mt-4" />

            <hr className="my-4 text-center content-center" />
            <div id="map" className="mt-4 text-center">
              <h2 className="text-xl mb-4">Get Directions</h2>
              <a
                href="https://www.google.com/maps/?q=27.693286,85.321134"
                title="Get Directions in Map"
                target="_blank"
              ></a>
            </div>
          </div>
        ...
        <div className="p-4 pb-0 rounded-r-2xl text-white con mb-4 text-center">
          ...
          <h2 className="text-xl mb-4">
            Message from the <span className="capitalize">Principal</span>
          </h2>
          <div className="mt-4 content-center items-center text-center text-sm">
            <img
              alt="Principal Photo"
              className="max-h-28 rounded-r-2xl"
              src=""
            />
